...
for scenario in scenarios:
    for year in years:
        netcdf_path = f"ACCESS-CM2_{scenario}_fwi_metrics_monthly_{year}.nc" # <-- Edit local location of netCDF files
        try:
            ...
            columns_to_check = ['FFMC', 'DMC', 'DC', 'ISI', 'BUI', 'FWI']
            ...
            for month, month_df in month_dfs.items():
                ...
                filename = f"ACCESS-CM2_{scenario}_{year}_{month}.tif" # <-- Edit local location of output .tif files
