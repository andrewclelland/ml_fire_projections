...
in_base = '/gws/nopw/j04/bas_climate/users/clelland/FWI/MRI-ESM2-0/{folder}/MRI-ESM2-0_{scenario}_{year}_{month}.tif'
out_base = '/gws/nopw/j04/bas_climate/users/clelland/FWI/COG/MRI-ESM2-0_COG/{folder}/MRI-ESM2-0_{scenario}_{year}_{month}_cog.tif'
