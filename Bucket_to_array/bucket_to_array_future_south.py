...
This file relates to the future period for the south Siberia model.
        ...
        for month in months:
            try:
                ...
                for band in chosen_bands:
                    ...
                    filename = f'/gws/nopw/j04/bas_climate/users/clelland/model/testing_access_south/{scenario}/testing_access_south_{scenario}_{year}_{month}_{band}_array.npy' # <-- Edit as necessary
